app.controller("SignupController", ["$scope", "$ionicLoading", "$window", "$state", "AlertService", "SignupService", function($scope, $ionicLoading, $window, $state, AlertService, SignupService) {
	//$scope.signupData = {};
	$scope.alerts = [];
